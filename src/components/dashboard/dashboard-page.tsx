...
import RecentArticles, { mockArticles as defaultMockArticles } from "./recent-article";

// Use the mock data from recent-article.tsx
const mockArticles = defaultMockArticles;

export function BlogDashboard() {
  // Calculate total comments across all articles
  const totalComments = mockArticles.reduce((total, article) => total + article.comments.length, 0);
